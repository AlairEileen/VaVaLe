 ...
 */
package space.alair.we_chat_pay.weixin;
...
public class WeiXinPay {
    ...
    public void startWXPay(String appId,String partnerId,String prepayId,
                           String nonceStr,String timeStamp,String sign,JPay.JPayListener listener){
    ...
    public void onResp(int error_code,String message) {
        ...
        if(error_code == 0) {
            ...
            //支付异常
            mJPayListener.onPayError(error_code,message);
